...
\begin{EntriesTable}
  ...
  \newline
  First class honours.\newline
  % Note that merit in Part III is equivalent to first class honours
...
\begin{EntriesTable}
  \Duration{2022}{2024}  &
  FRQNT Postdoctoral Research Scholarship (\$45,000)
  \\
  \Duration{2021}{2022}  &
...
%  \\
%  \Year{2017}  &
%  Second place at Fields Thesis Competition, Fields Institute, Toronto (\$300)
%  \\
%  \Year{2017}  &
%  Finalist at 3-Minute Thesis competition, University of Waterloo (\$100)
%  \Youtube{UQ1nW9PNil8}
%\end{EntriesTable}
